...
var observation_1 = require("../src/models/observation");
var suburbs = require("./suburbs");
var feel = require("./feelslike");
...
function randomPicker(size) {
    return Math.floor(Math.random() * size);
}
var seedDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var i, sIdx, fIdx, nIdx, obs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, observation_1.Observation.deleteMany({})];
            case 1:
                _a.sent();
                i = 0;
                _a.label = 2;
            case 2:
                ...
                sIdx = randomPicker(suburbs.length);
                fIdx = randomPicker(feel.length);
                nIdx = randomPicker(names.length);
                obs = new observation_1.Observation({
